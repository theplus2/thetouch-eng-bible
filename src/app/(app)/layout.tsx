export default function AppLayout({
  ...
  return (
    <div className="flex min-h-screen flex-col">
      ...
      {/* 모바일 하단 탭바 */}
      <nav className="fixed bottom-0 left-0 right-0 z-50 border-t border-surface-200 bg-white md:hidden">
      ...
      {/* PC 사이드바 */}
      <aside className="fixed left-0 top-0 hidden h-full w-64 border-r border-surface-200 bg-white md:block">
        <div className="p-6">
          <h2 className="text-lg font-bold text-primary-700">더터치 Bible</h2>
        </div>
        <nav className="mt-4 space-y-1 px-3">
          <a href="/home" className="flex items-center gap-3 rounded-lg px-3 py-2.5 text-sm text-surface-700 hover:bg-primary-50 hover:text-primary-700">
            <span>🏠</span> 홈 (대시보드)
          </a>
          <a href="/read" className="flex items-center gap-3 rounded-lg px-3 py-2.5 text-sm text-surface-700 hover:bg-primary-50 hover:text-primary-700">
            <span>📖</span> 성경 읽기
          </a>
          <a href="/vocabulary" className="flex items-center gap-3 rounded-lg px-3 py-2.5 text-sm text-surface-700 hover:bg-primary-50 hover:text-primary-700">
            <span>📝</span> 단어장
          </a>
          <a href="/group" className="flex items-center gap-3 rounded-lg px-3 py-2.5 text-sm text-surface-700 hover:bg-primary-50 hover:text-primary-700">
            <span>👥</span> 청년부 현황
          </a>
        </nav>
